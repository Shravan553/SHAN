...
import program from '../../assets/nutri-hero.jpg';
...
const NutritionalFacts = () => {
  ...
  return (
    <div className="nutri-container">
      ...
      <section className="nutritional-facts-section">
        <div className="facts-container">
          <h2 className="facts-title">Potato Nutrition Facts and Health Effects</h2>
          <p className="facts-description">
            The potato, scientifically known as Solanum tuberosum, was first domesticated around 8,000 to 10,000 years ago in the Andean region of South America. It is rich in essential nutrients, making it a valuable food source that provides numerous health benefits for all age groups, including vitamins, minerals, and dietary fiber. Potatoes are used worldwide as a versatile food staple. On this page, you will learn more about the global supply of potatoes.
          </p>
          <p className="facts-additional">
            "Unlock the nutritional treasure of potatoes—small in size, but mighty in health benefits!!"
          </p>
        </div>
      </section>
      <section>
