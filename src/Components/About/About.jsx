  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        <h3>ABOUT ANAND GROUP</h3>
        <h2>Bridging the Gap in the Potato Supply Chain</h2>
        <p>ANAND GROUP specializes in the potato trade, acting as a crucial intermediary between vendors and customers. We source premium potatoes from trusted growers and efficiently distribute them to businesses in nearby areas, ensuring a seamless supply chain.</p>
